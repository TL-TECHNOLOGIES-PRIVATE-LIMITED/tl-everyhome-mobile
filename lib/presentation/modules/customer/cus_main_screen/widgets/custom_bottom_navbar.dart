...
ValueNotifier<int> cusBottomNavIndexNotifier = ValueNotifier(0);

class CustomBottomNavigationBarCus extends StatelessWidget {
  const CustomBottomNavigationBarCus({
    super.key,
  });
